	...
	: CDialog(CSeriesPropDlg::IDD, pParent)
{
	...
	m_SeriesColour = 0x002068ff;
	m_ColourSelect.SetColour(m_SeriesColour);
}
...
{
	GetDlgItem(IDC_DATAPARAM1_TEXT)->SetWindowText(_T("Line Slope 斜率:"));
	GetDlgItem(IDC_DATAPARAM2_TEXT)->SetWindowText(_T("Line Offset 偏移量:"));
	GetDlgItem(IDC_DATAPARAM1_EDIT)->SetWindowText(_T("1.0"));
	GetDlgItem(IDC_DATAPARAM2_EDIT)->SetWindowText(_T("0.0"));
	GetDlgItem(IDC_POINTSNUMBER_EDIT)->SetWindowText(_T("100"));
}
...
{
	GetDlgItem(IDC_DATAPARAM1_TEXT)->SetWindowText(_T("Sine Amplitude 正弦振幅:"));
	GetDlgItem(IDC_DATAPARAM2_TEXT)->SetWindowText(_T("Sine Period 正弦周期:"));
	GetDlgItem(IDC_DATAPARAM1_EDIT)->SetWindowText(_T("3.0"));
	GetDlgItem(IDC_DATAPARAM2_EDIT)->SetWindowText(_T("5.0"));
	GetDlgItem(IDC_POINTSNUMBER_EDIT)->SetWindowText(_T("1000"));
}
